...
<body>
    <h1 style="text-align: center">Lupa Password DoNation</h1><br>
    <div class="container">
        ...
        <footer>
            ...
            <a href="/" target="_blank" class="text-gray-800 text-hover-primary" style="text-decoration: none; color:black"><b>Website DoNation</b></a>
        </footer>
    </div>
